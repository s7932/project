...
const ProductList = (props) => {
    ...
    const header = () => {
        ...
        return (
            <>
                ...
                <div className="flex justify-content-end" style={{color:"#ff69b4"}}>
    ...
    return (
        <div className="card">
            ...
            <DataScroller value={products} itemTemplate={listTemplate} rows={1} inline
                scrollHeight="80vh" layout={layout} header={header()}  />
            <Toast ref={toast} />
        </div>
    )
}
