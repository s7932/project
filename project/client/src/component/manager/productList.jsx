...
const ProductList = (props) => {
    ...
    const footerContent = (
        <div>
            ...
            <Button label="Yes" icon="pi pi-check" onClick={() => { deleteProduct(_id.current); props.refetch();setDeleteVisible(false) }} autoFocus />
        </div>
    );
    ...
    return (
        <>
            <div className="card">
                <DataScroller value={products} itemTemplate={listTemplate} rows={1} inline scrollHeight="80vh" layout={layout} header={header()} />
                <Toast ref={toast} />
            </div>
