...
useEffect(()=>
{
    ...
    return (
        <>
            <Card title={title} style={{ border: "2px solid #ff69b4" }}>
                <div>
                   {props.msg.wasShow==false? <h4 style={{color:"#ff69b4"}}>You have not read this message yet</h4>:<></>}
...
const [activeIndex,setActiveIndex]=useState(1)
    ...
    return (
        <>
            <Card title={title} style={{ border: "2px solid #ff69b4" }}>
                <div>
                   {props.msg.wasShow==false? <h4 style={{color:"#ff69b4"}}>{user.username} have not read this message yet</h4>:<></>}
                    <h4>Received at {props.msg.createdAt}</h4>
                    <div><br />
